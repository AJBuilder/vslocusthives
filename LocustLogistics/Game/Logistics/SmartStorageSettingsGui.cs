...
//            : base(Lang.Get("locusthives:hive-storage-settings"), blockEntityPos, capi)
//        {
//            this.mode = mode;
...
//            var tabs = new GuiTab[]
//            {
//                new GuiTab() { Name = Lang.Get("locusthives:tab-storage"), DataInt = 0 },
//                new GuiTab() { Name = Lang.Get("locusthives:tab-request"), DataInt = 1 },
//                new GuiTab() { Name = Lang.Get("locusthives:tab-push"), DataInt = 2 }
//            };
//
...
//                            .AddStaticText(Lang.Get("locusthives:pull-quota-mode"), CairoFont.WhiteSmallText(), switchTextBounds);
//
...
//                        SingleComposer.AddSmallButton(Lang.Get("locusthives:add-pull-request"), OnAddRequestButtonClicked, addButtonBounds);
//
//                        y += 40;
//
//                        // Request list area (placeholder for now)
//                        ElementBounds requestListBounds = ElementBounds.Fixed(0, y, 400, 200);
//                        SingleComposer.AddStaticText(Lang.Get("locusthives:pull-request-list-placeholder"),
...
//                            .AddStaticText(Lang.Get("locusthives:enable-push-mode"), CairoFont.WhiteSmallText(), switchTextBounds);
//                    }
//                    break;
//            }
//
